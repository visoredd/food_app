        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><!-- Full Width Page -->
                    <small>Update Auditorium</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">Update Auditorium</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
                ...
                <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
                    <div class="panel panel-danger" >
                        <div class="panel-heading app_heading_bg">
                            <div class="panel-title">Update Auditorium</div>
                        </div> 
                        <div style="padding-top:30px;" class="panel-body">
                            <form id="insert_auditorium_form" action="<?php echo base_url().'place/update_auditorium'; ?>" method="post" class="form-horizontal" role="form">
                                <div style="min-height:250px;">
                                    <div style="margin-bottom: 25px" class="input-group col-md-12">
                                                ...
                                                <select id="aud_theater" name="aud_theater" class="form-control">
                                                   <?php
                                                        foreach ($theatre_list as $theatre) {
                                                            echo '<option value="'.$theatre->th_id.'" '.(($theatre->th_id == $auditorium[0]->th_id) ? "selected": "").'>'.$theatre->th_name.'</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="aud_name" id="aud_name" value="<?php echo $auditorium[0]->auditorium_name; ?>" class="form-control">
                                                <input type="hidden" name="auditorium_id" id="auditorium_id" value="<?php echo $auditorium[0]->auditorium_id; ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
