						...
						<div class="shopping-content">
							<div class="row">
								...
								<div class="panel panel-danger">
								    <div class="panel-heading app_heading_bg app_panel_heading"><i class="fa fa-angle-double-right"></i> Location: <?php echo $location_name; ?> <i class="fa fa-angle-double-right"></i> <span class="active_heading">Theaters</span></div>
								    <div class="panel-body">
								    	<table class="table table-bordered">
								    		...
								    		<tbody>
							    				<?php
							    					if(! empty($theater_list)){
								    					$i = 1;
								    					foreach ($theater_list as $theater) {
								    						echo '
								    							<tr>
								    								<td>'.$i.'</td>
												    				<td>'.ucfirst($theater->th_name).'</td>
												    				<td align="center">
												    					<a href="'.base_url().'place/auditorium_list/'.$theater->th_id.'"><button class="btn btn-default">Auditoriums</button></a>
												    				</td>
												    				<td align="center">
