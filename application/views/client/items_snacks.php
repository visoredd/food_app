							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="<?php echo base_url();?>shopping/order_now"><img class="img-responsive" src="<?php echo base_url(); ?>img/shopping/shop2.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="<?php echo base_url();?>shopping/order_now">Byances Kcepte</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="<?php echo base_url();?>shopping/order_now"><img class="img-responsive" src="<?php echo base_url(); ?>img/shopping/shop3.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="<?php echo base_url();?>shopping/order_now">Cepturi Sintocc</a></h4>
